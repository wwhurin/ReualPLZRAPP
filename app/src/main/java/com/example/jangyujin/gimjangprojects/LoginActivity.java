...
public class LoginActivity extends Activity {
    ...
    private static String TAG = "LoginActiviry";

    private EditText mEditTextName;
    private EditText mEditTextPass;
    private TextView mTextViewResult;

    private static String Namego;

    public void onCreate(Bundle savedInstancesState){
        super.onCreate(savedInstancesState);
        setContentView(R.layout.login);

        mEditTextName = (EditText)findViewById(R.id.TId);
        mEditTextPass = (EditText)findViewById(R.id.TPwd);
        ...
        Button buttoninmem = (Button)findViewById(R.id.join_btn);
    ...
    class InsertData extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String serverURL = "http://wwhurin.dothome.co.kr/check.php";
            String postParameters = "name=" + name + "&pass=" + pass;
